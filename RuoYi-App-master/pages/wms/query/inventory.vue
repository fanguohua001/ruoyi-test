<!-- pages/wms/query/inventory.vue -->
<template>
  <view class="inventory-query">
    <!-- 搜索栏 -->
        ...
        >
          ...
          <view class="item-body">
            <view class="item-row">
              ...
              <text class="item-value">{{ item.locationCode }}</text>
            </view>
            <view class="item-row">
              <text class="item-label">现有数量:</text>
              <text class="item-value item-qty">{{ item.currentQty }}</text>
            </view>
            <view class="item-row">
              <text class="item-label">可用数量:</text>
              <text class="item-value" :class="item.availableQty > 0 ? 'text-green' : 'text-red'">{{ item.availableQty }}</text>
            </view>
            <view class="item-row">
              <text class="item-label">锁定数量:</text>
              <text class="item-value">{{ item.lockedQty || 0 }}</text>
            </view>
          </view>
        </view>
      </view>
